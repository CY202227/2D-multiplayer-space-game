...
{
    [SerializeField] private GameObject buttons; //allows private fields to be exposed in the Unity
    ...
    public async void CreateOrJoinLobby()
    {
        ...
        if (_connectedLobby != null) buttons.SetActive(false);
    }
    ...
    private async Task<Lobby> QuickJoinLobby()
    {
        try
        {
            ...
            // If we found one, grab the relay details
    ...
    private async Task<Lobby> CreateLobby()
    {
        try
        {
            ...
            // Create a lobby, adding join code
